...
public enum ResponseCode {
    ...
    USER_ALREADY_EXISTS(400, "用户名已存在", HttpStatus.BAD_REQUEST),
    INVALID_CREDENTIALS(401, "用户名或密码错误", HttpStatus.UNAUTHORIZED),
    INVALID_TOKEN(401, "Token无效", HttpStatus.UNAUTHORIZED),
